...
interface PaymentOptionsProps {
  ...
  totalPrice: number;
  selectedOption: "full" | "deposit" | "cash";
  onSelectOption: (option: "full" | "deposit" | "cash") => void;
  ...
  return (
    <div className="space-y-3">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[#666] text-[12px] font-normal font-sans">
                  Reserve now and pay on the day of your tour
                </div>
              </div>
            </div>
            <div className="shrink-0 text-right">
      ...
      {selectedOption === "cash" && (
        <div className="bg-[#fff5e6] border border-[#ffd4a8] rounded-lg p-3 mt-3">
          <p className="text-[#893300] text-[12px] font-normal font-sans">
            <strong>Note:</strong> No online payment will be taken now. Your booking will be pending until payment is received in person.
          </p>
        </div>
      )}
    </div>
